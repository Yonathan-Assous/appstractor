    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        return $request->wantsJson()
                    ? new Response('', 201)
                    : redirect('\login')->with('success', 'Your account has been created, please confirm with the email you received');
    }
    ...
    public function confirm($id, $token) {
        ...
        if ($user) {
            ...
            return redirect('\login')->with('error', 'Your token has expired');
        }
    }
    /**
